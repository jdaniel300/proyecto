...
drop schema if exists sayashop;
drop user if exists usuario_proyecto;
CREATE SCHEMA sayashop ;

/*Se crea un usuario para la base de datos llamado "usuario_proyecto" y tiene la contraseña "Usuario_Clave."*/
create user 'usuario_proyecto'@'%' identified by 'Usuar1o_Clave_Proyecto';

/*Se asignan los prvilegios sobr ela base de datos sayashop al usuario creado */
grant all privileges on sayashop.* to 'usuario_proyecto'@'%';
flush privileges;

/* la tabla de categoria contiene categorias de productos*/
create table sayashop.categoria (
...
create table sayashop.producto (
...
-- Creación de la tabla ObrasDeArte
CREATE TABLE ObrasDeArte (
  Id_obraDeArte INT PRIMARY KEY,
  id_producto INT,
  id_Artista INT,
  Tipo VARCHAR(50),
  Costo DECIMAL(10, 2),
...
-- Creación de la tabla ObrasXExposicion
CREATE TABLE ObrasXExposicion (
  Id_obraExpo INT PRIMARY KEY,
  Id_obraDeArte INT,
  Id_exposicion INT,
  Disponibilidad BOOLEAN,
  FOREIGN KEY (Id_obraDeArte) REFERENCES ObrasDeArte(Id_obraDeArte),
  FOREIGN KEY (Id_exposicion) REFERENCES Exposicion(Id_Exposicion)
);

-- Creación de la tabla Exposicion
CREATE TABLE Exposicion (
  Id_Exposicion INT PRIMARY KEY,
  Nombre VARCHAR(50),
  descripcion TEXT,
  fechaInicio DATE,
  fechaFin DATE
...
-- Creación de la tabla PromocionesXExpo
CREATE TABLE PromocionesXExpo (
  Id_PromocionXExpo INT PRIMARY KEY,
  Id_Promocion INT,
  Id_Exposicion INT,
...
INSERT INTO sayashop.usuario (id_usuario, username,password,nombre, apellidos, correo, telefono,ruta_imagen,activo) VALUES 
...
(2,'daniel','$2a$10$GkEj.ZzmQa/aEfDmtLIh3udIH5fMphx/35d0EYeqZL5uzgCJ0lQRi','Rebeca',  'Contreras Mora', 'acontreras@gmail.com', '5456-8789','https://upload.wikimedia.org/wikipedia/commons/0/06/Photo_of_Rebeca_Arthur.jpg',true),
(3,'oscar','$2a$10$koGR7eS22Pv5KdaVJKDcge04ZB53iMiw76.UjHPY.XyVYlYqXnPbO','Pedro', 'Mena Loria',     'lmena@gmail.com',      '7898-8936','https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Eduardo_de_Pedro_2019.jpg/480px-Eduardo_de_Pedro_2019.jpg?20200109230854',true);

/*Se insertan 3 categorias de productos como ejemplo */
INSERT INTO sayashop.categoria (id_categoria,descripcion,ruta_imagen,activo) VALUES 
...
INSERT INTO sayashop.producto (id_producto,id_categoria,descripcion,detalle,precio,existencias,ruta_imagen,activo) VALUES
...
INSERT INTO sayashop.factura (id_factura,id_usuario,fecha,total,estado) VALUES
...
INSERT INTO sayashop.venta (id_venta,id_factura,id_producto,precio,cantidad) values
(1,1,5,45000,3),
(2,1,9,15780,2),
(3,1,10,15000,3),
(4,2,5,45000,1),
...
insert into sayashop.rol (id_rol, nombre, id_usuario) values
